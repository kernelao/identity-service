...
import { RoleRequiredError } from '@/domain/authz/memberships/errors/RoleRequiredError';
import { InvalidScopeError } from '@/domain/authz/memberships/errors/InvalidScopeError';
import { isScopeAllowedForRoles } from '@/domain/authz/memberships/policies/RoleScopeMatrix';
import { MembershipGrantedEvent } from '@/domain/authz/memberships/events/MembershipGrantedEvent';
